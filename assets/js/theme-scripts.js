...
function changeTraveloElementUI() {
	...
	tjq('.datepicker-wrap2 input').datepicker({
        ...
        minDate: tjq('.datepicker-wrap input').val(),
    ...
    tjq('.datepicker-wrap-dob input').datepicker({
        ...
        /*showOtherMonths: true,*/
		yearRange: "-110:+0", // this is the option you're looking for
       // showOn: "both", 
		changeYear: true,
		changeMonth: true,
        maxDate: 0,
        ...
        beforeShow: function(input, inst) {
            ...
            var themeClass = tjq(input).parent().attr("class").replace("datepicker-wrap", "datepicker-wrap-dob");
    ...
    tjq('.datepicker-wrap-package input').datepicker({
