...
class Ajax_pagination{
	...
	var $next_link			= '<span aria-hidden="true">»</span>';
	var $prev_link			= '<span aria-hidden="true">«</span>';
	var $last_link			= 'Last';
	var $uri_segment		= 3;
	var $full_tag_open		= '<ul class="pagination pagination-text">';
	...
	function getAJAXlink( $count, $text) {
		...
		return "<a href=\"javascript:void(0);\"
		         " . $this->anchor_class . "
					...
					$('#". $this->div . "').html(data)" . $this->js_rebind ."; }); scrollToAnchor('apostlist');return false;\">"
				. $text .'</a>';
	}
