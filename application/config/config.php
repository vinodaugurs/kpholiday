...
//$config['base_url'] = 'http://kpholidays.com/';
$config['base_url'] = 'http://localhost/kpholidays/';

//$config['site_url'] = 'http://kktourz.com/app/travline/';
...
|
*/
$config['encryption_key'] = 'dsakjsdkhsakhdkaskd';
