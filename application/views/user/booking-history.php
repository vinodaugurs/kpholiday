...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-9">
            <!-- <div class="checkbox">
              <label><input class="i-check" type="checkbox" />Show only current trip</label>
            </div> -->
            <table class="table table-bordered table-striped table-booking-history">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="booking-history-type"><i class="fa fa-dashboard"></i><small>Bue</small>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="booking-history-title">augurs.in</td>
                        <td>New york City</td>
                        <td>4/12/2014</td>
                        <td>4/29/2014</td>
                        <td>$210</td>
