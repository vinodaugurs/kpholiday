        ...
        <div class="Register-Page">
          <div class="block">
            <div class="tab-container full-width-style white-bg">
              <ul class="tabs">
               <li><a href="<?php echo base_url('index.php/user/upcoming_bus_booking'); ?>" ><i class="fa fa-calendar-o"></i> Future booking</a></li>
                <li><a href="<?php echo base_url('index.php/user/history_bus_booking')?>" ><i class="fa fa-user"></i>Airline History Data</a></li>
                <li class="active"><a href="<?php echo base_url('index.php/user/cancel_bus_booking');?>" ><i class="fa fa-users"></i>Cancel Ticket</a></li>
                ...
                <div class="table-responsive">
                  <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><?php echo $cancelBooking['id']; ?></td>
