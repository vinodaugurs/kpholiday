...
<div class="container">
    <ul class="breadcrumb">
        ...
        <li><a href="javascript:void(0);">New York (NY)</a></li>
        <li class="active">New York City Flights</li>
    </ul>
    <h3 class="booking-title"><?= $len ?> Flight results found.</h3>
    <div class="row">
        <div class="col-md-3">
    ...
    $(".selectnow").click(function () {
        ...
        <?php } else { ?>
            ...
            $.ajax({
                ...
                success: function (data){window.location.href = '<?php echo base_url('index.php/flight/OnewayFlightBooking'); ?>/' + data;}
            });
        <?php } ?>
    });
