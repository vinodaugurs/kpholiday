                    ...
                    <div id="main" class="col-md-9">
                        <div class="tab-container style1" id="cruise-main-content">
                            ...
                            <div class="tab-content">
								...
								echo form_open('bus/BusBooking/'.$bus_dietail['ScheduleId'],$data);?>
                                    ...
                                    <div class="Bus-Seats-w3-upper">
                                        ...
                                        <div class="Bus-Seats-new2 Bus-w21">
                                            	...
                                            	<div class="bus-img-new"><img src="/img2/s.png" alt="" style="margin-bottom:15px;"/></br>&nbsp;&nbsp;<img src="/img2/Low2.png" alt=""/></div>
                                                <?php $setrow=0;
                                                ...
                                                <div class="Bus-Seats-new-row">
                                                    ...
                                                    <?php foreach($seatmap_row['Seats'] as $key2=>$seatmapclm){
															if(is_array($seatmapclm)){
																...
																$setrow++;
																 ?>
                                                        <li title="Seat No: <?php echo $seatmapclm['SeatNo']?> | Fare: Rs.<?php echo $priceBySeat[$seatmapclm['SeatTypeId']]['Fare']?>" class=" setselection <?php echo (array_key_exists($seatmapclm['SeatNo'],$bookedSeat))?'Seats-Low-Booked-Gents':'Seats-Low-Available'?>">
                                                ...
                                                <div class="Bus-Seats-up-row">
                                                	<ul>
                                                    	 <?php foreach($upper_berth_row as $key2=>$upper_berth_colm){?> 
                                                     	 <li title="Seat No: <?php echo $upper_berth_colm['SeatNo']?> | Fare: Rs.<?php echo $priceBySeat[$upper_berth_colm['SeatTypeId']]['Fare']?>" class=" setselectionup <?php echo (array_key_exists($upper_berth_colm['SeatNo'],$bookedSeat))?'Seats-up-Booked-Gents':'Seats-up-Available'?>">
...
-->
                                        ...
                                        <div class="col-sm-12">
                                        	...
                                        	<div class="Bus-Seats-w3-info">
                                                ...
                                                <li><span><img src="i/mg2/s-sp2.png" alt=""/></span>&nbsp;&nbsp;&nbsp;Selected Seat</li>
                                ...
                                <div class="tab-pane fade in active" id="cruise-description">
                                    <div class="intro table-wrapper full-width hidden-table-sms">
                                        <div class="col-sm-5 col-lg-4 features table-cell">
                                            <ul>
                                                <li><label>Bus name:</label><?php echo $bus_dietail['BusName']?></li>
                                                <li><label>Bus Type:</label><?php echo $bus_dietail['BusType']?></li>
                                                <li><label>Transport Name:</label><?php echo $bus_dietail['TransportName']?></li>
                                                <li><label>Departure Time:</label><?php echo $bus_dietail['DepartureTime']?></li>
                                                <li><label>Arrival Time:</label><?php echo $bus_dietail['ArrivalTime']?></li>
                                                <li><label>Available Seat:</label><?php echo $bus_dietail['AvailableSeatCount']?></li>
                            ...
                            <?php foreach($Buses['SearchOutput']['AvailableBuses'] as $key=>$bus){?>
                                ...
                                <article class="box">
                                   <!-- <figure class="col-xs-3">
                                    ...
                                    <a href="#" class="button btn-large full-width">LOAD MORE CARS</a>
                                </div>
                                    ...
                                    <div class="intro table-wrapper full-width hidden-table-sms">
                                        ...
                                        <div class="table-cell col-sm-8">
                                            <div class="detailed-rating">
                                                <ul class="clearfix">
                                                    <li class="col-md-6"><div class="each-rating"><label>Ship Quality</label><div class="five-stars-container"><div class="five-stars" style="width: 78%;"></div></div></div></li>
                                                    <li class="col-md-6"><div class="each-rating"><label>Ship Staff Quality</label><div class="five-stars-container"><div class="five-stars" style="width: 78%;"></div></div></div></li>
                                                    <li class="col-md-6"><div class="each-rating"><label>Dining/Food</label><div class="five-stars-container"><div class="five-stars" style="width: 78%;"></div></div></div></li>
                                                    <li class="col-md-6"><div class="each-rating"><label>Activities</label><div class="five-stars-container"><div class="five-stars" style="width: 78%;"></div></div></div></li>
                                                    <li class="col-md-6"><div class="each-rating"><label>rooms Quality</label><div class="five-stars-container"><div class="five-stars" style="width: 78%;"></div></div></div></li>
                                                    <li class="col-md-6"><div class="each-rating"><label>Play areas</label><div class="five-stars-container"><div class="five-stars" style="width: 78%;"></div></div></div></li>
