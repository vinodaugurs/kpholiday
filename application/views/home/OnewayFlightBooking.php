    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="booking-section travelo-box">
                <form class="booking-form" action="<?php echo base_url('index.php/flight/OnewayFlightBooking/' . $Flight_dietail['UserTrackId']); ?>" method="post">
                    <div class="person-information">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6 col-md-5">
                                ...
                                <input required type="text" name="user_name" class="form-control" value="<?php echo (set_value('user_name') == false) ? @$user_details['first_name'] : set_value('user_name') ?>" placeholder="Name" />
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-6 col-md-5">
                        ...
                        <?php
                        $result = $this->user_model->get_table_data('city', 'city');
                        ?>
                        <div class="form-group row">
                            <div class="col-sm-6 col-md-5">
                        ...
                        <div class="card-information">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 col-md-5">                                       
                                    ...
                                    <input type="text" class="date-pick-years form-control" required name="adult_DateofBirth[]" value="<?php echo (set_value("adult_DateofBirth[$i]") != false) ? set_value("adult_DateofBirth[$i]") : '' ?>" placeholder="DateofBirth" />
                                </div>
                            </div>
                        </div>
                        <hr/>
                    ...
                    <?php for ($i = 0; $i < $flight_search['child']; $i++) { ?>
                        <div class="card-information">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 col-md-5">                                       
                                    <label>Date of Birth</label>
                                    <input type="text" class="date-pick-years form-control" required name="child_DateofBirth[]" value="<?php echo (set_value("child_DateofBirth[$i]") != false) ? set_value("child_DateofBirth[$i]") : '' ?>"  placeholder="DateofBirth" />
                                </div>
                    ...
                    <?php for ($i = 0; $i < $flight_search['infant']; $i++) { ?>
                        <div class="card-information">
                            <h2>Infant Passenger Details</h2>
                            <div class="form-group row">
                                <div class="col-sm-6 col-md-5">                                        
                                    <label>Title</label>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 col-md-5">                                       
                                    <label>Date of Birth</label>
                                    <input type="text" class="date-pick-years form-control" required name="infant_DateofBirth[]" value="<?php echo (set_value("infant_DateofBirth[$i]") != false) ? set_value("infant_DateofBirth[$i]") : '' ?>" placeholder="DateofBirth" />
                                </div>
                    ...
                    <li>
                        ...
                        <ul class="booking-item-payment-price">
                            <li>
                                ...
                                <p class="booking-item-payment-price-amount">INR <?php echo $tax_details['TaxOutput']['TaxResFlightSegments'][0]['AdultTax']['FareBreakUpDetails']['BasicAmount']; ?></p>
                            </li>
                            <li>
                                <p class="booking-item-payment-price-title">Total Tax Amount</p>
                                <p class="booking-item-payment-price-amount">INR <?php echo $tax_details['TaxOutput']['TaxResFlightSegments'][0]['AdultTax']['FareBreakUpDetails']['TotalTaxAmount']; ?></p>
                            </li>
                            <li>
                                <p class="booking-item-payment-price-title">Transaction Fee</p>
                                <p class="booking-item-payment-price-amount">INR <?php echo $tax_details['TaxOutput']['TaxResFlightSegments'][0]['AdultTax']['FareBreakUpDetails']['TransactionFee']; ?></p>
                            </li>
                            <li>
                                <p class="booking-item-payment-price-title">Service Charge</p>
                                <p class="booking-item-payment-price-amount">INR <?php echo $tax_details['TaxOutput']['TaxResFlightSegments'][0]['AdultTax']['FareBreakUpDetails']['ServiceCharge']; ?></p>
                            </li>
                            <li>
                                <p class="booking-item-payment-price-title">Gross Amount</p>
                                <p class="booking-item-payment-price-amount">INR <?php echo $tax_details['TaxOutput']['TaxResFlightSegments'][0]['AdultTax']['FareBreakUpDetails']['GrossAmount']; ?></p>
                            </li>
                            <li>
                                <p class="booking-item-payment-price-title">Total Amount</p>
                                <p class="booking-item-payment-price-amount">INR <?php echo $tax_details['TaxOutput']['TaxResFlightSegments'][0]['AdultTax']['FareBreakUpDetails']['GrossAmount'] * $flight_search['adult']; ?></p>
                            </li>                            
                            <?php $gTotal = $tax_details['TaxOutput']['TaxResFlightSegments'][0]['AdultTax']['FareBreakUpDetails']['GrossAmount'] * $flight_search['adult']; ?>
                            <?php if ($flight_search['way'] == 'R') { ?>
                            <li><div class="gap"></div></li>
                            <li>
                                <p class="booking-item-payment-price-title">Return Basic Amount</p>
                                <p class="booking-item-payment-price-amount">INR <?php echo $return_tax_details['TaxOutput']['TaxResFlightSegments'][0]['AdultTax']['FareBreakUpDetails']['BasicAmount']; ?></p>
                            </li>
                            <li>
                                <p class="booking-item-payment-price-title">Return Total Tax Amount</p>
                                <p class="booking-item-payment-price-amount">INR <?php echo $return_tax_details['TaxOutput']['TaxResFlightSegments'][0]['AdultTax']['FareBreakUpDetails']['TotalTaxAmount']; ?></p>
                            </li>
                            <li>
                                <p class="booking-item-payment-price-title">Return Transaction Fee</p>
                                <p class="booking-item-payment-price-amount">INR <?php echo $return_tax_details['TaxOutput']['TaxResFlightSegments'][0]['AdultTax']['FareBreakUpDetails']['TransactionFee']; ?></p>
                            </li>
                            <li>
                                <p class="booking-item-payment-price-title">Return Service Charge</p>
                                <p class="booking-item-payment-price-amount">INR <?php echo $return_tax_details['TaxOutput']['TaxResFlightSegments'][0]['AdultTax']['FareBreakUpDetails']['ServiceCharge']; ?></p>
                            </li>
                            <li>
                                <p class="booking-item-payment-price-title">Return Gross Amount</p>
                                <p class="booking-item-payment-price-amount">INR <?php echo $return_tax_details['TaxOutput']['TaxResFlightSegments'][0]['AdultTax']['FareBreakUpDetails']['GrossAmount']; ?></p>
                            </li>
                            <li>
                                <p class="booking-item-payment-price-title">Return Total Amount</p>
                                <p class="booking-item-payment-price-amount">INR <?php echo $return_tax_details['TaxOutput']['TaxResFlightSegments'][0]['AdultTax']['FareBreakUpDetails']['GrossAmount'] * $flight_search['adult']; ?></p>
                            </li>
                            <?php $gTotal = $gTotal + $return_tax_details['TaxOutput']['TaxResFlightSegments'][0]['AdultTax']['FareBreakUpDetails']['GrossAmount'] * $flight_search['adult'];?>
                            <?php } ?>
                        </ul>
                        ...
                        <ul class="booking-item-payment-price">
                            <li>
                                <p class="booking-item-payment-price-title">Basic Amount</p>
                                <p class="booking-item-payment-price-amount">INR <?php echo $tax_details['TaxOutput']['TaxResFlightSegments'][0]['ChildTax']['FareBreakUpDetails']['BasicAmount']; ?></p>
                            </li>
                            <li>
                                <p class="booking-item-payment-price-title">Total Tax Amount</p>
                                <p class="booking-item-payment-price-amount">INR <?php echo $tax_details['TaxOutput']['TaxResFlightSegments'][0]['ChildTax']['FareBreakUpDetails']['TotalTaxAmount']; ?></p>
                            </li>
                            <li>
                                <p class="booking-item-payment-price-title">Transaction Fee</p>
                                <p class="booking-item-payment-price-amount">INR <?php echo $tax_details['TaxOutput']['TaxResFlightSegments'][0]['ChildTax']['FareBreakUpDetails']['TransactionFee']; ?></p>
                            </li>
                            <li>
                                <p class="booking-item-payment-price-title">Service Charge</p>
                                <p class="booking-item-payment-price-amount">INR <?php echo $tax_details['TaxOutput']['TaxResFlightSegments'][0]['ChildTax']['FareBreakUpDetails']['ServiceCharge']; ?></p>
                            </li>
                            <li>
                                <p class="booking-item-payment-price-title">Gross Amount</p>
                                <p class="booking-item-payment-price-amount">INR <?php echo $tax_details['TaxOutput']['TaxResFlightSegments'][0]['ChildTax']['FareBreakUpDetails']['GrossAmount']; ?></p>
                            </li>
                            <li>
                                <p class="booking-item-payment-price-title">Total Amount</p>
                                <p class="booking-item-payment-price-amount">INR <?php echo $tax_details['TaxOutput']['TaxResFlightSegments'][0]['ChildTax']['FareBreakUpDetails']['GrossAmount'] * $flight_search['child']; ?></p>
                            </li>                            
                            <?php $gTotal = $tax_details['TaxOutput']['TaxResFlightSegments'][0]['ChildTax']['FareBreakUpDetails']['GrossAmount'] * $flight_search['child']; ?>
                            <?php if ($flight_search['way'] == 'R') { ?>
                            <li><div class="gap"></div></li>
                            <li>
                                <p class="booking-item-payment-price-title">Return Basic Amount</p>
                                <p class="booking-item-payment-price-amount"><?php echo $return_tax_details['TaxOutput']['TaxResFlightSegments'][0]['ChildTax']['FareBreakUpDetails']['BasicAmount']; ?></p>
                            </li>
                            <li>
                                <p class="booking-item-payment-price-title">Return Total Tax Amount</p>
                                <p class="booking-item-payment-price-amount">INR <?php echo $return_tax_details['TaxOutput']['TaxResFlightSegments'][0]['ChildTax']['FareBreakUpDetails']['TotalTaxAmount']; ?></p>
                            </li>
                            <li>
                                <p class="booking-item-payment-price-title">Return Transaction Fee</p>
                                <p class="booking-item-payment-price-amount">INR <?php echo $return_tax_details['TaxOutput']['TaxResFlightSegments'][0]['ChildTax']['FareBreakUpDetails']['TransactionFee']; ?></p>
                            </li>
                            <li>
                                <p class="booking-item-payment-price-title">Return Service Charge</p>
                                <p class="booking-item-payment-price-amount">INR <?php echo $return_tax_details['TaxOutput']['TaxResFlightSegments'][0]['ChildTax']['FareBreakUpDetails']['ServiceCharge']; ?></p>
                            </li>
                            <li>
                                <p class="booking-item-payment-price-title">Return Gross Amount</p>
                                <p class="booking-item-payment-price-amount">INR <?php echo $return_tax_details['TaxOutput']['TaxResFlightSegments'][0]['ChildTax']['FareBreakUpDetails']['GrossAmount']; ?></p>
                            </li>
                            <li>
                                <p class="booking-item-payment-price-title">Return Total Amount</p>
                                <p class="booking-item-payment-price-amount">INR <?php echo $return_tax_details['TaxOutput']['TaxResFlightSegments'][0]['ChildTax']['FareBreakUpDetails']['GrossAmount'] * $flight_search['child']; ?></p>
                            </li>
                            <?php $gTotal = $gTotal + $return_tax_details['TaxOutput']['TaxResFlightSegments'][0]['ChildTax']['FareBreakUpDetails']['GrossAmount'] * $flight_search['child'];?>
                            <?php } ?>
                        </ul>
                        <?php } ?>
                        ...
                        <ul class="booking-item-payment-price">
                            <li>
                                <p class="booking-item-payment-price-title">Basic Amount</p>
                                <p class="booking-item-payment-price-amount">INR <?php echo $tax_details['TaxOutput']['TaxResFlightSegments'][0]['InfantTax']['FareBreakUpDetails']['BasicAmount']; ?></p>
                            </li>
                            <li>
                                <p class="booking-item-payment-price-title">Total Tax Amount</p>
                                <p class="booking-item-payment-price-amount">INR <?php echo $tax_details['TaxOutput']['TaxResFlightSegments'][0]['InfantTax']['FareBreakUpDetails']['TotalTaxAmount']; ?></p>
                            </li>
                            <li>
                                <p class="booking-item-payment-price-title">Transaction Fee</p>
                                <p class="booking-item-payment-price-amount">INR <?php echo $tax_details['TaxOutput']['TaxResFlightSegments'][0]['InfantTax']['FareBreakUpDetails']['TransactionFee']; ?></p>
                            </li>
                            <li>
                                <p class="booking-item-payment-price-title">Service Charge</p>
                                <p class="booking-item-payment-price-amount">INR <?php echo $tax_details['TaxOutput']['TaxResFlightSegments'][0]['InfantTax']['FareBreakUpDetails']['ServiceCharge']; ?></p>
                            </li>
                            <li>
                                <p class="booking-item-payment-price-title">Gross Amount</p>
                                <p class="booking-item-payment-price-amount">INR <?php echo $tax_details['TaxOutput']['TaxResFlightSegments'][0]['InfantTax']['FareBreakUpDetails']['GrossAmount']; ?></p>
                            </li>
                            <li>
                                <p class="booking-item-payment-price-title">Total Amount</p>
                                <p class="booking-item-payment-price-amount">INR <?php echo $tax_details['TaxOutput']['TaxResFlightSegments'][0]['InfantTax']['FareBreakUpDetails']['GrossAmount'] * $flight_search['infant']; ?></p>
                            </li>                            
                            <?php $gTotal = $tax_details['TaxOutput']['TaxResFlightSegments'][0]['InfantTax']['FareBreakUpDetails']['GrossAmount'] * $flight_search['infant']; ?>
                            <?php if ($flight_search['way'] == 'R') { ?>
                            <li><div class="gap"></div></li>
                            <li>
                                <p class="booking-item-payment-price-title">Return Basic Amount</p>
                                <p class="booking-item-payment-price-amount">INR <?php echo $return_tax_details['TaxOutput']['TaxResFlightSegments'][0]['InfantTax']['FareBreakUpDetails']['BasicAmount']; ?></p>
                            </li>
                            <li>
                                <p class="booking-item-payment-price-title">Return Total Tax Amount</p>
                                <p class="booking-item-payment-price-amount">INR <?php echo $return_tax_details['TaxOutput']['TaxResFlightSegments'][0]['InfantTax']['FareBreakUpDetails']['TotalTaxAmount']; ?></p>
                            </li>
                            <li>
                                <p class="booking-item-payment-price-title">Return Transaction Fee</p>
                                <p class="booking-item-payment-price-amount">INR <?php echo $return_tax_details['TaxOutput']['TaxResFlightSegments'][0]['InfantTax']['FareBreakUpDetails']['TransactionFee']; ?></p>
                            </li>
                            <li>
                                <p class="booking-item-payment-price-title">Return Service Charge</p>
                                <p class="booking-item-payment-price-amount">INR <?php echo $return_tax_details['TaxOutput']['TaxResFlightSegments'][0]['InfantTax']['FareBreakUpDetails']['ServiceCharge']; ?></p>
                            </li>
                            <li>
                                <p class="booking-item-payment-price-title">Return Gross Amount</p>
                                <p class="booking-item-payment-price-amount">INR <?php echo $return_tax_details['TaxOutput']['TaxResFlightSegments'][0]['InfantTax']['FareBreakUpDetails']['GrossAmount']; ?></p>
                            </li>
                            <li>
                                <p class="booking-item-payment-price-title">Return Total Amount</p>
                                <p class="booking-item-payment-price-amount">INR <?php echo $return_tax_details['TaxOutput']['TaxResFlightSegments'][0]['InfantTax']['FareBreakUpDetails']['GrossAmount'] * $flight_search['infant']; ?></p>
                            </li>
                            <?php $gTotal = $gTotal + $return_tax_details['TaxOutput']['TaxResFlightSegments'][0]['InfantTax']['FareBreakUpDetails']['GrossAmount'] * $flight_search['infant'];?>
                            <?php } ?>
                        </ul>
                        <?php } ?>
