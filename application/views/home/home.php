...
<!--                            <iframe height='265' scrolling='no' title='simpleWeather Auto Update' src='//codepen.io/fleeting/embed/mdwlI/?height=265&theme-id=0&default-tab=html,result&embed-version=2' frameborder='no' allowtransparency='true' allowfullscreen='true' style='width: 100%;'>See the Pen <a href='http://codepen.io/fleeting/pen/mdwlI/'>simpleWeather Auto Update</a> by James Fleeting (<a href='http://codepen.io/fleeting'>@fleeting</a>) on <a href='http://codepen.io'>CodePen</a>.
</iframe>-->
<!--                            <h3 class="loc-info-title"><img src="<?php echo base_url(); ?>assets/img/flags/32/in-f.png" alt="Image augurs" title="kpholidays"/>Lucknow</h3>
                            <p class="loc-info-weather"><span class="loc-info-weather-num">+31</span><i class="im im-rain loc-info-weather-icon"></i></p>
                        ...
                        <div class="thumb">
                            <header class="thumb-header">
                                <a class="hover-img curved" href="<?php echo site_url('home/view_detail/' . $dest['id']); ?>">
                                	<?php $main_img=($dest['main_image']!='')?$dest['main_image']:'No_Image.jpg'?>
                                    <img width="270" height="160" src="<?php echo base_url('upload/destination/' . $main_img); ?>" alt="Image  augurs" title="the journey home"/><i class="fa fa-plus box-icon-white box-icon-border hover-icon-top-right round"></i>
                                </a>
                            </header>
                            <div class="thumb-caption">
                    ...
                    <div class="col-md-3">
                        <div class="thumb">
                            <header class="thumb-header">
                                ...
                                <?php $main_img=($pack['front_image']!='')?$pack['front_image']:'No_Image.jpg'?>
                                    <img width="270" height="160" src="<?php echo base_url('upload/package/' . $main_img); ?>" alt="Package Image" title="the journey home"/><i class="fa fa-plus box-icon-white box-icon-border hover-icon-top-right round"></i>
                                </a>
                            </header>
                            <div class="thumb-caption">
