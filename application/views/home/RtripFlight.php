...
<div class="container">
    ...
    <h3 class="booking-title"><?=$Olen + $Rlen?> Flight results found.</h3>
    <div class="row">
        <div class="col-md-3">
...
<script>
    ...
    $(".selectnow1").click(function () {
        currentlselection = $(this);
        <?php if ($this->session->userdata('uid') != '') {?>
        updateTicketselection();
        <?php } else { ?>
            var booking_data = currentlselection.attr('id');
            window.location.href = '<?php echo base_url('index.php/flight/OnewayFlightBooking'); ?>/' + booking_data;
        <?php } ?>
    });
    function updateTicketselection1() {
        var booking_data = currentlselection.attr('id');
        ...
        $.ajax({
            ...
            {
                if (data != 'true') {
                    window.location.href = '<?php echo base_url('index.php/flight/OnewayFlightBooking'); ?>/' + data;
                } else {
