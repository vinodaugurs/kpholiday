                    ...
                    <div class="tab-container style1" id="hotel-main-content">
                        <div class="tab-content">
                            ...
                            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                                ...
                                <?php 
                                    $gallery = explode(',', $detail[0]['gallery']);
                                    $imgCount = 0;
                                    foreach($gallery as $galleryImg) { 
                                    if($imgCount == 0) { ?>
                                        <div class="item active">
                                            <img
                                                src="<?php echo base_url('upload/package/' . $galleryImg); ?>"
                                                alt="...">
                                ...
                                <?php $imgCount++; } ?>
                                    <!-- <?php for ($i = 1; $i <= 6; $i++) {
                                        if ($detail[0]['gallery'] != '') {
                                            ...
                                            <?php } else { ?>
                                                <div class="item">
                                                    <img src="<?php echo base_url('upload/package/' . $detail[0]['gallery']); ?>" alt="...">
                                                    <div class="carousel-caption"></div>
                                                </div>
                                            <?php } ?>
                                        <?php }
                            ...
                            <?php foreach ($pack_list as $list) { ?>
                                ...
                                <article class="box">
                                    ...
                                    <figure>
                                        ...
                                        <a href="#"><img
                                                src="<?php echo base_url('upload/package/' . $list['front_image']); ?>"
