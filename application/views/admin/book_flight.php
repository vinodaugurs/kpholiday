              ...
              <table class="table table-striped table-bordered table-hover" id="dataTables-example">
			   ...
			   foreach($display as $value){?>
                ...
                <tr class="odd gradeX">
                    ...
                    <td class="warning"><?php echo $value['TravelType'];?></td>
                    <td class="warning"><?php echo $value['BookingType'];?></td>
                    ...
                    <td class="warning"><?php echo $value['BaseOrigin'];?></td>
                    <td class="warning"><?php echo $value['BaseDestination'];?></td>
