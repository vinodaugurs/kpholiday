                                   ...
                                   <thead>
                                    ...
                                    <tbody>
                                       ...
                                       // $this->output->enable_profiler(TRUE);
                                        $dispidata = $this->pack_model->getdisputebyadminnid($editid);  
                                        $to = $this->pack_model->getdispbyid($dispidata[0]['disp_id']); 
                                    ...
                                    <form action="<?php echo base_url(); ?>index.php/admin/dispute" method="post">
                                            <td><textarea name="msg" class="form-control" rows="3"><?php echo $dispval['message'] ; ?></textarea></td>
                                        <td><?php  echo $dispval['date'];  ?></td>
                                        <td> <input type="hidden" name="ed" value="<?php echo $dispval['disp_id']; ?>"><input type="hidden" name="upid" value="<?php echo $editid; ?>"><input type="hidden" name="editid" value="<?php echo $editid; ?>"><button class="btn btn-warning"><i class="icon-ok-sign"></i></button></form><br>
                                        <br>
