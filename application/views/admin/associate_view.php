                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        $apdata = $this->admin_model->getallasso();  
                                        $c=1;
                                            ...
                                            <td><form method="post" action ="suspend?id=<?php echo $apval['uid']?>" onsubmit="return confirm('Do you really want to proceed?');" > <input type="hidden" name="sus" value="<?php  if ($apval['status']==='suspend')
                                        {
                                         ...
                                         echo 1;
                                        }else{ echo 0; } ?>"><input type="hidden" name="uid" value="<?php echo $apval['uid'];?>"><button  id="<?php echo $apval['uid'];?>" class="btn btn-success btn-xs"  ><i class="icon-off"></i></button></form></br>
