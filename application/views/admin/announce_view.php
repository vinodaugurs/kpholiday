...
<div class="panel panel-primary">
                        <div class="panel-heading">
                            <i class="icon-volume-up"></i> Announcement
                        </div>
                        <div class="panel-body">
                            ...
                            <form action="<?php echo base_url() ;?>index.php/admin/announcement" method="post">
                             <div class="form-group">
                                            <label>Select Recipient</label>
                                            <select name="annorecipient" class="form-control">
                                 ...
                                 <?php echo form_error('annorecipient'); ?>
                                <div class="form-group">
                                            <label>Email Body</label>
                               
                                            <textarea name="annomessage" id="wysihtml5" class="form-control" rows="10"></textarea>
                                ...
                                <button class="btn btn-success btn-sm" > <i class="icon-volume-down"></i> Announce</button>
