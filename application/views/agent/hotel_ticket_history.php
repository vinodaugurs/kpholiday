    ...
    <div align="center" class="panel panel-info">
        ...
        <div class="panel-heading">
            <h3 class="panel-title">
               <span class="CL">HOTEL TICKET HISTORY</span>
            </h3>
        </div>
   
    <div style="text-align: left;" class="panel-body ">
        <div id="cphETTSS_upipanelHeader">
				<form action="<?php echo base_url('index.php/agent/hotel_ticket_history') ?>" method="post">
                <div class="row">
                ...
                <tr>
                    ...
                    <div class="radio">
                      ...
                      <label>
                        ...
                        <input type="radio"  value="Booking Confirmed" <?php echo ((isset($_GET['hotel_mode_booked']) and $_GET['hotel_mode_booked']=='bookedTicket') or !isset($_GET['hotel_mode_booked']))?'checked':'';?> name="hotel_mode_booked" id="Ticket_booked" checked>
                        BOOKED TICKETS
                      </label>
                      </div>
                         <div class="radio">
                      ...
                      <label>
                          <input type="radio" value="Booking Cancel" <?php echo (isset($_GET['hotel_mode_booked']) and $_GET['hotel_mode_booked']=='cancelledTicket')?'checked':'';?> name="hotel_mode_booked" id="Ticket_cancel">CANCELLED TICKETS
                      </label>
                      </div>
                         <div class="radio">

                      <label>
                          <input type="radio" value="Domestic" name="hotel-type" <?php echo ((isset($_GET['hotel-type']) and $_GET['hotel-type']=='Domestic') or !isset($_GET['hotel-type']))?'checked':'';?> checked/>Domestic
                      </label>
                      </div>
                         <div class="radio">
                      <label>
                          <input type="radio" value="International" <?php echo (isset($_GET['hotel-type']) and $_GET['hotel-type']=='International')?'checked':'';?> name="hotel-type"/>International
                      </label>
                    ...
                    <div class="col-md-4">
                    <input type="checkbox" id="all-booking" name="all-booking" value="all-booking-data"><span>ALL BOOKING</span>
                    </div>
                </div>
                </div>
                <div class="row">
					...
					<input class="input-text full-width" id="from_date" type="text" value="<?php if(isset($_GET['from-date'])){ echo $_GET['from-date']; } ?>" placeholder="From Date" name="from-date" required>
					...
					<input class="input-text full-width" id="to_date" type="text" value="<?php if(isset($_GET['to-date'])){echo $_GET['to-date'];} ?>" placeholder="To Date" name="to-date" required>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <select  id="filter1" class="form-control" name="filter1" disabled>
									...
									<option <?php echo (isset($_GET['filter1']) and $_GET['filter1']=='ClientTrackId')?'selected="selected"':'';?> value="ClientTrackId">Client Track Id</option>
									
									<option <?php echo (isset($_GET['filter1']) and $_GET['filter1']=='UserTrackId')?'selected="selected"':'';?> value="TrackID">Track Id</option>

                  <option <?php echo (isset($_GET['filter1']) and $_GET['filter1']=='CheckIn')?'selected="selected"':'';?>  value="CheckIn">Travel Date</option>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <select id="filter2" class="form-control" name="filter2" disabled>
									...
									<option <?php echo (isset($_GET['filter2']) and $_GET['filter2']=='BaseOrigin')?'selected="selected"':'';?> value="ClientTrackId">Client Track Id</option>
									
									<option <?php echo (isset($_GET['filter2']) and $_GET['filter2']=='UserTrackId')?'selected="selected"':'';?> value="TrackID">Track id.</option>

                  <option <?php echo (isset($_GET['filter2']) and $_GET['filter2']=='CheckInTime')?'selected="selected"':'';?>  value="CheckInTime">Travel Date</option>
  ...
  <table class="table table-hover">
    ...
    <tbody>
     ...
     <?php foreach ($result as $print) { ?>
        ...
        <td><?php echo $print['BookingAmount'] ?></td>
        <td><?php echo $print['agentMarkup'] ?></td>
