...
<link href="http://kpholidays.com/agent/css/style.css" rel="stylesheet">
<link href="http://kpholidays.com/agent/css/main.css" rel="stylesheet">

<div class="page-title detail-page-title" style="background-image:url('http://kpholidays.com/assets/11111.jpg');">
<div class="container">
  <div class="flex-row">
    ...
    <div class="row">
      <div class="col-md-9" role="main">
        <div class="detail-content-wrapper">
          ...
          <div id="section-3" class="detail-content" style="display:none;">
            <div class="section-title text-left">
          ...
          <ul class="scrollspy-sidenav">
            <li>
              <ul class="nav">
                ...
                <li style="display:none;"><a href="#section-3" class="anchor">Tour Accommodation</a></li>
                <li><a href="#section-4" class="anchor">What's Included</a></li>
                <li><a href="#section-5" class="anchor">Availabilities</a></li>
                <li style="display:none;"><a href="#section-6" class="anchor">Information &amp; FAQ</a></li>
                <li style="display:none;"><a href="#section-7" class="anchor">Reviews</a></li>
              </ul>
            </li>
          </ul>
