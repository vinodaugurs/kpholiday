    ...
    <label class="CL" for="cphETTSS_chkboxAll">
      <input type="checkbox" id="all-booking" name="all-booking" value="all-booking-data"> ALL BOOKING
                ...
                <div class="row">
                    ...
                    <input class="input-text full-width" type="text" placeholder="From Date" name="from-date" value="<?php if(isset($_GET['from-date'])){ echo $_GET['from-date']; } ?>" required>
                    ...
                    <input class="input-text full-width" type="text" placeholder="To Date" name="to-date" value="<?php if(isset($_GET['to-date'])){echo $_GET['to-date'];} ?>" required>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <select  id="filter1" class="form-control" name="filter1" disabled>
									...
									<option <?php echo (isset($_GET['filter1']) and $_GET['filter1']=='BaseDestination')?'selected="selected"':'';?> value="Destination" >Destination</option>
									<option <?php echo (isset($_GET['filter1']) and $_GET['filter1']=='BaseOrigin')?'selected="selected"':'';?> value="Origin">Origin</option>
									<option <?php echo (isset($_GET['filter1']) and $_GET['filter1']=='UserTrackId')?'selected="selected"':'';?> value="UserTrackId">User Track Id</option>
                                    <option <?php echo (isset($_GET['filter1']) and $_GET['filter1']=='DepartureDateTime')?'selected="selected"':'';?>  value="TravelDate">Travel Date</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="filter1" name="filter1Result" value="<?php if(isset($_GET['filter1Result'])){echo $_GET['filter1Result'];} ?>" disabled>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <select id="filter2" class="form-control" name="filter2" disabled>
									<option value="" selected="selected">--Select--</option>
									<option <?php echo (isset($_GET['filter2']) and $_GET['filter2']=='BaseDestination')?'selected="selected"':'';?> value="Destination">Destination</option>
									<option <?php echo (isset($_GET['filter2']) and $_GET['filter2']=='BaseOrigin')?'selected="selected"':'';?> value="Origin">Origin</option>
									
									<option <?php echo (isset($_GET['filter2']) and $_GET['filter2']=='UserTrackId')?'selected="selected"':'';?> value="UserTrackId">User Track id.</option>
                                    <option <?php echo (isset($_GET['filter2']) and $_GET['filter2']=='DepartureDateTime')?'selected="selected"':'';?>  value="TravelDate">Travel Date</option>
                            ...
                            <div class="col-md-6">
                                <br>
                                <div class="form-group">
                                <input type="text" class="form-control" id="filter2" name="filter2Result" value="<?php if(isset($_GET['filter2Result'])){echo $_GET['filter2Result'];} ?>" disabled>
                                </div>  
                            </div>
                        </div>
                    </div>
