...
<div class="container">
    ...
    <div style="text-align: left;" class="panel-body ">
        <div id="cphETTSS_upipanelHeader">
				...
				<tbody><tr>
					<td>
					<span><input type="radio"  value="CONFIRM" name="hotel_mode_booked" id="Ticket_booked" checked>
					</span>
					<label class="CL">BOOKED TICKETS</label></td>
					<td><span><input type="radio" value="Booking Cancel" name="hotel_mode_booked" id="Ticket_cancel"></span><label>CANCELLED TICKETS</label>
					</td>
    ...
    <label class="CL" for="cphETTSS_chkboxAll">
      <input type="checkbox" id="all-booking" name="all-booking" value="all-booking-data"> ALL BOOKING
                ...
                <div class="row">
                    ...
                    <input class="input-text full-width" type="text" placeholder="From Date" name="from-date" value="<?php echo (set_value('from-date')== True)?set_value('from-date'):""; ?>" required>
                    ...
                    <input class="input-text full-width" type="text" placeholder="To Date" name="to-date" value="<?php echo (set_value('to-date')== True)?set_value('to-date'):""; ?>" required>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <select  id="filter1" class="form-control" name="filter1" disabled>
									...
									<option value="UserTrackId">User Track Id</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="filter1" name="filter1Result" value="<?php echo (set_value('filterResult')== True)?set_value('filterResult'):""; ?>" disabled>
                                </div>
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <br>
                                <div class="form-group">
                                <input type="text" class="form-control" id="filter2" name="filter2Result" value="<?php echo (set_value('filter2Result')== True)?set_value('filter2Result'):""; ?>" disabled>
                                </div>  
                            </div>
                        </div>
                    </div>
