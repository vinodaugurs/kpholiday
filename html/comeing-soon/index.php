...
<!-- Contact Icon end here -->
	...
	<section class="container main-wrapper">
		...
		<section id="logo" class="fade-down">
			<a href="#" title="kpholidays">
            	<img src="img/logo.png" alt="kpholidays">
            </a>
		</section>
		<!-- Logo end here -->
		<!-- Slogan start here -->
		...
		<footer class="fade-down">        
			<p class="footer-text">&copy; KP Holidays 2016, All Rights Reserved. </p>
		</footer>
		<!-- Footer end here -->
	</section>
<!-- About start here -->
      ...
      <div class="modal-content pop-up pop-up-cnt">
        ...
        <div class="clearfix cnt-wrap">
          <div class="col-md-4 col-sm-4">
            ...
            <h4>Phone</h4>
            <p>Phone:  +91-9956241414 <br />Mobile:  +91-9956241414 <br />Fax:  +91-9956241414</p>
          </div>

          <div class="col-md-4 col-sm-4">      
            <i class="fa fa-envelope-o"></i>
            <h4>Email</h4>
            <p>pradeep241414@gmail.com<br />pradeep241414@gmail.com</p>
          </div>
          <div class="col-md-4 col-sm-4">
